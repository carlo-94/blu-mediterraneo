/* ===================== I18N dictionary (IT/EN/ES) ===================== */
  const I18N = {
    ...
    "nav.gallery": { it:"Galleria", en:"Gallery", es:"Galería" },
    "nav.reviews": { it:"Recensioni", en:"Reviews", es:"Reseñas" },
    ...
    "services.cap.label": { it:"1–3 ospiti", en:"1–3 guests", es:"1–3 huéspedes" },
    "services.cap.value": { it:"Camera matrimoniale + divano letto", en:"Double bedroom + sofa bed", es:"Dormitorio doble + sofá cama" },
    ...
    "services.ac.value": { it:"Climatizzazione estate/inverno", en:"Heating & cooling all year", es:"Calefacción y refrigeración todo el año" },
    "services.kitchen.label": { it:"Cucina", en:"Kitchen", es:"Cocina" },
    "services.kitchen.value": { it:"Fornetto, piano cottura, frigorifero", en:"toaster oven, cooktop, refrigerator", es:"minihorno eléctrico, encimera y frigorífico" },
    ...
    "extras.bagage.desc": { it:"Possibilità di lasciare i bagagli in deposito dopo il check-out entro la giornata.", en:"Luggage storage available after check-out until the end of the day.", es:"Posibilidad de dejar el equipaje en consigna después del check-out hasta el final del día."},
    "extras.late.title": { it:"Late check-out", en:"Late check-out", es:"Check-out tardío" },
    "extras.late.desc": { it:"Dopo le 10:00, in base alla disponibilità.", en:"After 10:00 a.m., subject to availability.", es:"Después de las 10:00, según disponibilidad." },
    "rules.title": { it:"Regole della casa", en:"House rules", es:"Normas de la casa" },
    "rules.more": { it:"Regole +", en:"Rules +", es:"Normas +" },
    "rules.times": { it:"Check-in 16:00–22:00 · Check-out entro le 10:00", en:"Check-in 4:00–10:00 PM · Check-out by 10:00 AM", es:"Check-in 16:00–22:00 · Check-out hasta las 10:00" },
    "rules.idlaw": { it:"Documento d’identità all’arrivo (obbligo di legge)", en:"ID required at check-in (by law)", es:"Documento de identidad requerido al check-in (por ley)" },
    "rules.nosmoke": { it:"Appartamento per non fumatori", en:"Non-smoking apartment", es:"Alojamiento para no fumadores" },
    "rules.noparties": { it:"No feste/eventi non autorizzati", en:"No parties/events without approval", es:"No fiestas/eventos sin autorización" },
    "rules.pets": { it:"Animali solo su richiesta e previa conferma", en:"Pets on request and prior approval only", es:"Mascotas solo bajo petición y previa confirmación" },
    "rules.quiet": { it:"Silenzio dopo le 22:00 (rispetto del vicinato)", en:"Quiet hours after 10 PM (respect neighbors)", es:"Silencio después de las 22:00 (respeta al vecindario)" },
    "gallery.title": { it:"Galleria", en:"Gallery", es:"Galería" },
    "gallery.tab.day": { it:"Zona giorno", en:"Living area", es:"Zona de día" },
    "gallery.tab.night": { it:"Zona notte", en:"Bedroom", es:"Dormitorio" },
    "gallery.tab.bath": { it:"Bagno", en:"Bathroom", es:"Baño" },
    "gallery.tab.balcony": { it:"Balcone / Esterni", en:"Balcony / Outside", es:"Balcón / Exteriores" },
    "reviews.title": { it:"Recensioni", en:"Reviews", es:"Reseñas" },
    "reviews.more": { it:"Recensioni +", en:"Reviews +", es:"Reseñas +" },
    "reviews.r1": { it:"“A due passi dal centro storico e dal lungomare: posizione perfetta per muoversi a piedi o con i mezzi. La zona è molto silenziosa, il letto è comodissimo. L’appartamento è ampio, nuovissimo, con impianti perfettamente funzionanti; cucina e bagno sono attrezzati con tutti i comfort. Molto luminoso, dispone di due balconi, uno dei quali con una splendida vista sulla Chiesa dell’Annunziata. Abbiamo trovato questa posizione ideale anche per imbarcarsi facilmente sui traghetti verso la Costiera Amalfitana. Giovanni ci ha accolti di persona, fornendoci utili indicazioni su ristoranti e luoghi da visitare, ed è stato molto flessibile con l’orario di check-in. Inoltre ci ha gentilmente permesso di lasciare i bagagli ben oltre l’orario di check-out. Torneremo sicuramente in questo appartamento.”", en:"“Just a short walk from the historic center and the seafront, in a perfect location for getting around on foot or by public transport. The area is very quiet and the bed is extremely comfortable. The apartment is spacious, brand new, with perfectly functioning systems; the kitchen and bathroom are fully equipped with all amenities. It is very bright and has two balconies, one of which offers a beautiful view of the Church of the Annunziata. We also found it very convenient as a base to take the ferry and visit the Amalfi Coast. Giovanni welcomed us in person, gave us helpful tips on restaurants and places to visit, and was very flexible with check-in. He also kindly allowed us to leave our luggage well beyond the check-out time. We will definitely return to this apartment.”", es:"“A pocos pasos del centro histórico y del paseo marítimo, en una ubicación perfecta para moverse a pie o en transporte público. La zona es muy tranquila y la cama es muy cómoda. El apartamento es amplio, nuevo, con instalaciones que funcionan perfectamente; la cocina y el baño están completamente equipados con todas las comodidades. Es muy luminoso y tiene dos balcones, uno de ellos con una hermosa vista de la iglesia de la Annunziata. También nos pareció una base ideal para tomar el ferry y visitar la Costa Amalfitana. Giovanni nos recibió en persona, nos dio recomendaciones muy útiles sobre restaurantes y lugares que visitar, y fue muy flexible con la hora de check-in. Además, nos permitió dejar el equipaje mucho después de la hora de check-out. Sin duda volveremos a este apartamento.”" },
    "reviews.r2": { it:"“Splendido appartamento, curato in ogni dettaglio. Molto pulito, arredato in modo ottimale e dotato di tutti i servizi essenziali e non solo. Abbiamo apprezzato l’attenzione del proprietario e di suo figlio Carlo, che offrono anche un servizio navetta extra, facoltativo e a pagamento: persona molto discreta, disponibile e professionale. Una vera combinazione di comfort e ospitalità. Lo consigliamo vivamente.”", en:"“Beautiful apartment, cared for in every detail. Very clean, functionally furnished and equipped with all essential amenities and more. We really appreciated the attention of the owner and his son Carlo. There is also an extra shuttle service available, optional and for a fee, with a very discreet and helpful driver. A perfect combination of comfort and hospitality. We highly recommend it.”", es:"“Precioso apartamento, cuidado en cada detalle. Muy limpio, amueblado de forma funcional y equipado con todas las comodidades esenciales y más. Apreciamos mucho la atención del propietario y de su hijo Carlo. También hay disponible un servicio de traslado extra, opcional y de pago, con un conductor muy discreto y servicial. Una combinación perfecta de comodidad y hospitalidad. Lo recomendamos altamente.”" },
    "reviews.r3": { it:"“Ci siamo trovati subito benissimo nell’appartamento: tutto era molto pulito, accogliente e perfettamente attrezzato. In cucina non mancava nulla, c’era l’aria condizionata per le giornate più calde, un letto comodo e anche un piccolo balcone con una bella vista. Giovanni è stato un ottimo padrone di casa: molto cordiale, disponibile e ci è venuto a prendere di persona. Grazie per l’eccellente soggiorno, torneremo volentieri!”", en:"“We immediately felt very comfortable in the apartment: everything was very clean, cozy, and perfectly equipped. The kitchen had everything we needed, there was air conditioning for the hotter days, a comfortable bed, and even a small balcony with a nice view. Giovanni was an excellent host: very friendly, helpful, and he came to pick us up in person. Thank you for the wonderful stay — we will gladly come back”", es:"“Nos sentimos inmediatamente muy a gusto en el apartamento: todo estaba muy limpio, acogedor y perfectamente equipado. En la cocina no faltaba nada, había aire acondicionado para los días más calurosos, una cama cómoda y hasta un pequeño balcón con una bonita vista. Giovanni fue un excelente anfitrión: muy amable, atento y vino a recogernos personalmente. Gracias por la estancia maravillosa, ¡volveremos con mucho gusto!”" },
    "reviews.r4": { it:"“L’appartamento si trova nel centro storico di Salerno, in una strada tranquilla a pochi passi da bar, ristoranti e supermercati. Come in molte zone della città, per raggiungerlo c’è una salita piuttosto ripida. Gli spazi sono contenuti ma ben organizzati e arredati, con due balconi. L’host è stato molto cordiale e comunicativo.”", en:"“The apartment is located in Salerno’s historic center, on a quiet street just a short walk from bars, restaurants, and supermarkets. As in many parts of the city, there’s a fairly steep hill up to the apartment. The space is compact but well laid out and furnished, with two balconies. The host was very friendly and communicative.”", es:"“El apartamento se encuentra en el centro histórico de Salerno, en una calle tranquila y a pocos pasos de bares, restaurantes y supermercados. Como en muchas zonas de la ciudad, hay una cuesta bastante empinada para llegar al apartamento. El espacio es compacto pero bien distribuido y amueblado, con dos balcones. El anfitrión fue muy amable y comunicativo.”" },
    "itin.titleNear": { it:"Itinerari vicini", en:"Nearby itineraries", es:"Itinerarios cercanos" },
    "itin.hint": { it:"Idee per mezza giornata o giornata intera. Tempi indicativi da Blu Mediterraneo.", en:"Ideas for a half or full day. Approximate times from Blu Mediterraneo.", es:"Ideas para medio día o día completo. Tiempos aproximados desde Blu Mediterraneo." },
    ...
    "itin.seasonal": { it:"⛴️ Servizio traghetti", en:"⛴️ Ferries service", es:"⛴️ servicio ferries" },
    "itin.ferryNote": { it:"Per traghetti e orari cliccare sul bottone “Traghetti”: si apre il sito di Travelmar.", en:"For ferries and timetables click the “Ferries” button: it opens the Travelmar website.", es:"Para ferries y horarios, haz clic en “Ferries”: se abre la web de Travelmar." },
    "badge.coast": { it:"🌊 Costiera", en:"🌊 Coast", es:"🌊 Costa" },
    "badge.village": { it:"🏘️ Borgo", en:"🏘️ Village", es:"🏘️ Pueblo" },
    "badge.iconic": { it:"⭐ Iconico", en:"⭐ Iconic", es:"⭐ Icónico" },
    "badge.views": { it:"🏔️ Panorami", en:"🏔️ Viewpoints", es:"🏔️ Miradores" },
    "badge.spots": { it:"📷 Scorci", en:"📷 Photo spots", es:"📷 Rincones" },
    "badge.unesco": { it:"🏛️ UNESCO", en:"🏛️ UNESCO", es:"🏛️ UNESCO" },
    ...
    "contact.orLead": { it:"Oppure scrivici su", en:"Or message us on", es:"O escríbenos por" },
    "contact.orMid": { it:"o via email a", en:"or via email at", es:"o por correo a" },
    "contact.where": { it:"Dove siamo", en:"Where we are", es:"Dónde estamos" },
    ...
    "contact.msgPh": { it:"Scrivi qui...", en:"Write here...", es:"Escribe aquí..." },
    "contact.hi": { it:"Ciao,", en:"Hello,", es:"Hola," },
    "contact.thanks": { it:"Grazie!", en:"Thank you!", es:"¡Gracias!" },
  ...
  "aria.openLang": { it:"Apri selettore lingua", en:"Open language selector", es:"Abrir selector de idioma" },
    ...
    function buildEmail(lang){
      ...
      const subject = `${t('contact.subjectBase', lang)}${name ? ` – ${name}` : ''} – ${dateStr}`;
    ...
    function updateWhatsAppLink(lang){
      ...
      const msgInfo = l === 'en' ? "Hello! I would like information about Blu Mediterraneo"
                     : l === 'es' ? "¡Hola! Me gustaría información sobre Blu Mediterraneo"
      ...
      const msgShuttle = l === 'en' ? "Hi! I'd like a shuttle/tour quote (Blu Mediterraneo). Date __, time __, route __, passengers __."
                       : l === 'es' ? "¡Hola! Quisiera un presupuesto de traslado/tour (Blu Mediterraneo). Fecha __, hora __, ruta __, pasajeros __."
    ...
    /* ===== Galleria ===== */
    const GALLERY_TABS = [
      { id:"giorno",  i18n:"gallery.tab.day",     folder:"images/zona_pranzo",  total:12, captionBase:{it:"Zona giorno", en:"Living area", es:"Zona de día"} },
      { id:"notte",   i18n:"gallery.tab.night",   folder:"images/camera_letto", total:7,  captionBase:{it:"Zona notte",  en:"Bedroom",     es:"Dormitorio"} },
      { id:"bagno",   i18n:"gallery.tab.bath",    folder:"images/bagno",        total:4,  captionBase:{it:"Bagno",       en:"Bathroom",    es:"Baño"} },
      { id:"balcone", i18n:"gallery.tab.balcony", folder:"images/esterni",      total:11, captionBase:{it:"Balcone / Esterni", en:"Balcony / Outside", es:"Balcón / Exteriores"} },
    ];
    ...
    function setMenu(open){
      ...
      // ricalcola (header può cambiare altezza)
